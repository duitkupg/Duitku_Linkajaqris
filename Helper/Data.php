...
namespace Duitku\Linkajaqris\Helper;
// include_once('Duitku/ApiRequestor.php');
// include_once('Duitku/DuitkuCore.php');
use Duitku\Linkajaqris\Helper\DuitkuConstants;
use Duitku\Linkajaqris\Helper\Duitku\Duitku_Linkajaqris_Core;
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
     * @var \Duitku\Linkajaqris\Logger\DuitkuLogger
     */
     ...
     * @param \Duitku\Linkajaqris\Logger\DuitkuLogger $duitkuLogger
     * @param \Magento\Framework\Encryption\EncryptorInterface $encryptor
     * @param \Magento\Framework\Module\ModuleListInterface $moduleList
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Duitku\Linkajaqris\Logger\DuitkuLogger $duitkuLogger,
    ...
    {
        return $this->getConfigData($field, 'duitku_linkajaqrisepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_Linkajaqris_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_Linkajaqris")['setup_version'];
    }
     ...
     *
     * @param \Duitku\Linkajaqris\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
