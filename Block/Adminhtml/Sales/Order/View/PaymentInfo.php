 ...
 *
 */
namespace Duitku\Linkajaqris\Block\Adminhtml\Sales\Order\View;

use Duitku\Linkajaqris\Model\Method\Epay\Payment as EpayPayment;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
    ...
    /**
     * @var \Duitku\Linkajaqris\Helper\Data
     */
     ...
     * @param \Duitku\Linkajaqris\Helper\Data $duitkuHelper
     * @param array $data
     */
    public function __construct(
        ...
        \Duitku\Linkajaqris\Helper\Data $duitkuHelper,
        array $data = []
    ) {
    ...
    public function getTransactionData()
    {
       ...
       if ($paymentMethod === EpayPayment::METHOD_CODE) {
            /** @var \Duitku\Linkajaqris\Model\Method\Epay\Payment */
     ...
     *
     * @param \Duitku\Linkajaqris\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\Linkajaqris\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
