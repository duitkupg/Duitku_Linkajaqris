 ...
 *
 */
namespace Duitku\Linkajaqris\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Linkajaqris\Helper\DuitkuConstants;

class Payment extends \Duitku\Linkajaqris\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_linkajaqrisepay';
    const METHOD_REFERENCE = 'duitkulinkajaqrisReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Linkajaqris\Block\Info\View';
    ...
    /**
     * @var \Duitku\Linkajaqris\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Linkajaqris\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Linkajaqris\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_linkajaqrisepay/merchantnumber');
    ...
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epaylinkajaqris/callback?isAjax=true&form_key='.$FormKey->getFormKey());
    $returnUrl = $this->_urlBuilder->getUrl('duitku/epaylinkajaqris/accept');
     ...
     * @return \Duitku\Linkajaqris\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaylinkajaqris/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaylinkajaqris/cancel', ['_secure' => $this->_request->isSecure()]);
    }
